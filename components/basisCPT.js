...
class basisCPT extends BaseComponent {
  ...
  langData(url, method, resp) {
    this.indexDBData.langData = resp;
  }
  // 自启动用户信息获取
  ...
  sideBarSub_componentNode() {
    ...
    let htmlText = `<div id="scriptCPT_innerHead"><h1>组件</h1></div><div id="scriptCPT_mainBody"><table><tbody><tr><td>前台功能</td><td>设置</td></tr>`;
